...
///
/// Copied from [aiRatingRepository].
@ProviderFor(aiRatingRepository)
final aiRatingRepositoryProvider =
    AutoDisposeProvider<AiRatingRepository>.internal(
      aiRatingRepository,
      name: r'aiRatingRepositoryProvider',
      debugGetCreateSourceHash:
          const bool.fromEnvironment('dart.vm.product')
              ? null
              : _$aiRatingRepositoryHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
